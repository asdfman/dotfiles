...
export def main [] {
    ...
    return {
        ...
        range: $color_palette.yellow
        float: $color_palette.flamingo
        string: $color_palette.green
        nothing: $color_palette.lavender
        binary: $color_palette.maroon
        'cell-path': $color_palette.teal
        row_index: { fg: $color_palette.mauve attr: "b" }
        record: $color_palette.sky
        list: $color_palette.sapphire
        block: $color_palette.rosewater
        hints: $color_palette.overlay1
        search_result: { fg: $color_palette.red bg: $color_palette.overlay0 }
